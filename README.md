Hospital Resource Pressure Score (HRPS)

A Streamlit dashboard that combines the indicators of NHS emergency care into a single score representing the pressure on hospital resources.
